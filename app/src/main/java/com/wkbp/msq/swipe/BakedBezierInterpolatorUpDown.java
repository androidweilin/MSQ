 ...
 */
final class BakedBezierInterpolatorUpDown implements Interpolator {
    private static final BakedBezierInterpolatorUpDown INSTANCE = new BakedBezierInterpolatorUpDown();

    public final static BakedBezierInterpolatorUpDown getInstance() {
        return INSTANCE;
    }
     ...
     */
    private BakedBezierInterpolatorUpDown() {
        super();
    }
