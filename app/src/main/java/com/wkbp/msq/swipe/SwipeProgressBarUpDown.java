 ...
 * trigger a refresh).
 */
final class SwipeProgressBarUpDown{
    ...
    private static final Interpolator INTERPOLATOR = BakedBezierInterpolatorUpDown.getInstance();
    ...
    public SwipeProgressBarUpDown(View parent) {
        mParent = parent;
        mColor1 = COLOR1;
        mColor2 = COLOR2;
        mColor3 = COLOR3;
